...
export default function AdminLayout() {
  ...
  const navItems = [
    { name: "Dashboard", path: "/shopadmin/shopdashboard" },
    { name: "Create Bill", path: "/shopadmin/create-bill" },
    { name: "Bill History", path: "/shopadmin/bill-history" },
    { name: "Add Items", path: "/shopadmin/inventory" },
    { name:"View Items", path:"/shopadmin/inventory-list"},
     { name:"Recharge", path:"/shopadmin/Recharge"},
    { name:"Your Profile", path:"/shopadmin/ShopProfile"}
